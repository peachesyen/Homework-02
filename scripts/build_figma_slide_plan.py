...
slides = [
    ...
    Slide(
        ...
        description=(
            ...
            "(matching the real card style used elsewhere in the app: 16px "
            "radius, soft shadow, colored 3px border alternating orange/magenta) "
            "laid out left to right with arrow connectors: (1) '20-Frame Capture' "
            "using the dashed orange tracking-circle motif from the capture "
            "screen, (2) 'Gemini 1.5 Flash', (3) 'Structured Mood JSON', (4) "
            "'3 Outputs'. Small eyebrow label HOW IT WORKS above in tracked "
            "orange uppercase, no quotes."
        ),
    ...
    Slide(
        ...
        description=(
            ...
            "distress alert auto-suggests nearby vets. Headline above the row, "
            "no quotes: Beyond the Score."
        ),
